        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <a href="https://www.instagram.com/adharvaa_suzuki/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-600 transition" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/adharvaasuzukitwowheelers" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>
              <a href="https://api.whatsapp.com/send/?phone=918940057000" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-600 transition" aria-label="WhatsApp">
              ...
              <a href="https://maps.app.goo.gl/yy1fpVosonULPXcCA" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-red-600 transition" aria-label="Google Maps">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C7.589 0 4 3.589 4 8c0 4.245 7.273 15.107 7.583 15.567a1 1 0 0 0 1.834 0C13.727 23.107 21 12.245 21 8c0-4.411-3.589-8-9-8zm0 11c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z" /></svg>
              </a>
            </div>
          </div>
          <div>
